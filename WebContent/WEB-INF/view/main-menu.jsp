...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/resources/us-states.js"></script>
                                ...
                                <div class="col">
									...
									<form method="post">
										<div data-role="rangeslider" data-mini="true">
											<input type="range" name="phase0_population-val" id="phase0_population-val" value="80" min="0" max="100">
										</div>
									</form>	
									...
									<form method="post">
										<div data-role="rangeslider" data-mini="true">
											<input type="range" name="phase0_vote-min" id="phase0_vote-min" value="20" min="0" max="100">
											<input type="range" name="phase0_vote-max" id="phase0_vote-max" value="80" min="0" max="100">
										</div>
									</form>											
